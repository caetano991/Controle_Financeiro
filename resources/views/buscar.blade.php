...
<head>
    ...
    @vite(['resources/css/appBuscar.css'])
...
<div class="corpo">
  <div class="corpo_select_query">
    <form action="{{ route('user-show') }}" method="GET">
        <div class="select_data_categoria">
            <label for="opcoes" class="escolher_filtro_busca">Escolha um filtro:</label><br><br>
            
            <select name="filtro" class="opcoes_de_busca">
        ...
        <a href="{{ route('user-buscar') }}" class="btn btn-danger">↪ Limpar Filtros</a>
    </form>
  </div>
